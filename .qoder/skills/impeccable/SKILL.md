...
allowed-tools:
  - Bash(npx impeccable *)
  - Bash(.qoder/skills/impeccable/scripts/impeccable *)
---
...
**Pin / Unpin:** `.qoder/skills/impeccable/scripts/impeccable pin <pin|unpin> <command>` creates or removes a standalone `/<command>` shortcut. Report the script's result concisely; relay stderr verbatim on error.
