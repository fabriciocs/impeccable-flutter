/**
 * puppeteer-core helpers that drive the live-mode bar UI exactly the way a user
...
async function clickBarButton(page, label) {
  ...
  // human-visible click target stays puppeteer-core-stable. Dispatch the click on
...
/**
 * Poll until a marked hero is visible. Uses puppeteer-core's visible check so
