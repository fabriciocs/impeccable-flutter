...
allowed-tools:
  - Bash(npx impeccable *)
  - Bash(.grok/skills/impeccable/scripts/impeccable *)
---
...
**Pin / Unpin:** `.grok/skills/impeccable/scripts/impeccable pin <pin|unpin> <command>` creates or removes a standalone `/<command>` shortcut. Report the script's result concisely; relay stderr verbatim on error.
